...
document.getElementById('calculate').addEventListener('click', function(){
    // Esta linha obtém o valor digitado no elemento HTML com o ID 'value' e armazena na variavel 'value'.
    ...
    // Esta linha atualiza o conteúdo do elemento HTML com ID 'total' para mostrar o resultado formatado
